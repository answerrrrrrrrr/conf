...
inoremap <C-S-Down> ddpi
inoremap <C-S-Up> ddkPi
inoremap <C-Tab> :tabnexti
...
nmap <silent> ,vv :e $DOTFILES/vimrc
nnoremap ,w :w
nnoremap ,q :q
nnoremap ,P "+P
nnoremap ,p "+p
...
nnoremap ,y "+y
vnoremap ,y "+y
vnoremap <silent> ,tt :execute 'tabnext ' . g:last_active_tab
...
nmap ,u :GundoToggle
nmap ,gd :cs find d =expand('<cword>')
nmap ,gi :cs find i ^=expand('<cfile>')$
nmap ,gf :cs find f =expand('<cfile>')
nmap ,ge :cs find e =expand('<cword>')
nmap ,gt :cs find t =expand('<cword>')
nmap ,gc :cs find c =expand('<cword>')
nmap ,gg :cs find g =expand('<cword>')
nmap ,gs :cs find s =expand('<cword>')
...
noremap <silent> <F9> :MarkdownPreview
noremap <F8> :SyntasticToggleMode
noremap <F7> :NeoCompleteToggle
noremap <F6> :exec exists('syntax_on') ? 'syn off' : 'syn on'
noremap <F4> :set wrap! wrap?
noremap <F3> :set list! list?
noremap <F1> :call SetMouse()
map <Down> <Nop>
map <Up> <Nop>
noremap <Right> :bn
noremap <Left> :bp
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-monokai/,~/.vim/plugged/vim-airline/,~/.vim/plugged/vim-indent-guides/,~/.vim/plugged/vim-easy-align/,~/.vim/plugged/syntastic/,~/.vim/plugged/nerdtree/,~/.vim/plugged/nerdcommenter/,~/.vim/plugged/tagbar/,~/.vim/plugged/vim-easymotion/,~/.vim/plugged/vim-multiple-cursors/,~/.vim/plugged/a.vim/,~/.vim/plugged/gtags.vim/,~/.vim/plugged/gundo.vim/,~/.vim/plugged/vim-expand-region/,~/.vim/plugged/rainbow_parentheses.vim/,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/ctrlsf.vim/,~/.vim/plugged/vim-signature/,~/.vim/plugged/vim-obsession/,~/.vim/plugged/vim-quickrun/,~/.vim/plugged/neocomplete/,~/.vim/plugged/markdown-preview.vim/,~/.vim/plugged/vim-markdown/,~/.vim/plugged/tabular/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/powerline-develop/powerline/bindings/vim,~/.fzf,~/.vim/plugged/ctrlsf.vim/after,~/.vim/plugged/vim-signature/after,~/.vim/plugged/vim-markdown/after,~/.vim/plugged/tabular/after,~/.vim/after
set scrolloff=5
set shiftround
set shiftwidth=4
set shortmess=atI
